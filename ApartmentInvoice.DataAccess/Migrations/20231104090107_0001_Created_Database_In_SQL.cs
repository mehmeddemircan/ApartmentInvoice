...
{
    /// <inheritdoc />
    public partial class _0001_Created_Database_In_SQL : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Month = table.Column<int>(type: "int", nullable: false),
                    Year = table.Column<int>(type: "int", nullable: false),
                    BillStatu = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscriptionStatu = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<int>(type: "int", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlatSubscriptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FlatSubscriptions_Flats_FlatId",
                        column: x => x.FlatId,
                        principalTable: "Flats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlatSubscriptions_Subscriptions_SubscriptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlatSubscriptions_FlatId",
                table: "FlatSubscriptions",
                column: "FlatId");

            migrationBuilder.CreateIndex(
                name: "IX_FlatSubscriptions_SubscriptionId",
                table: "FlatSubscriptions",
